...
from Changes import apply_drift,create_new_clusters
...
args = {'weight' : [0.025,0.025,0.95], 'dimensionality' : 3, 'min_projected_dim' : 3, 
       'max_projected_dim' : 3, 'min_coordinate' : -10, 'max_coordinate' : 10, 
       'min_projected_dim_var' : 0.1, 'max_projected_dim_var': 0.3, 'class_label' : [1,1,0]}

create_new_clusters(sg.clusters, args)