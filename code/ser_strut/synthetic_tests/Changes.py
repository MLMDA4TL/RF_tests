...
def apply_drift(clusters, cluster_feature_speed, min_coordinate, max_coordinate):
	...
	for cluster_id, feature_speed in cluster_feature_speed.iteritems():
		for feature, speed in feature_speed.iteritems():
...
def change_cluster_weight(clusters, clusters_weights):
	for cluster_id, weight in clusters_weights.iteritems():
		clusters[cluster_id].weight = weight

def loose_feature(clusters,clusters_features):
	for cluster_id, features in clusters_features.iteritems():
